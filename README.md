...
A collection of talks and projects, made available here for anyone who
wants to run them, read the code, or follow along.

## Talks

- [Understanding AI](Talks/understanding-ai) - Building an AI agent from
  scratch in .NET 10, in seven runnable steps: echo loop, stateless LLM
  calls, chat memory, native C# skills, knowledge cutoff, retrieval-augmented
  generation, and MCP tools.
...
- [Multi-Tenant Azure Bicep](Projects/IaC/Multi-Tenant-Azure-Bicep) - A multi-tenant
  ...
  template, with a pull-request `what-if` gate before changes reach
  production.
