...
using ShopTheKafka.ShippingService;
...
public partial class Program
{
    ...
    public static IHost CreateHost(string[] args, Action<ILoggingBuilder>? configureLogging = null)
    {
        ...
        {
            settings.Config.GroupId = "shipping-service";
            settings.Config.AutoOffsetReset = AutoOffsetReset.Earliest;
            // Explicit per ADR 0007: ShippingService's log-and-skip error policy depends on the offset being
